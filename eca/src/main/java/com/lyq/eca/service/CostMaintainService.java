...
public class CostMaintainService{
    ...
    public List<CostMaintain> findByPidAndType(int pid,String type){
        return costMaintainDao.findByPidAndType(pid,type);
    }
    ...
    public List<Object[]> getMsumByDate(){
        //costMaintainDao.refresh();
        return costMaintainDao.getMsumByDate();
    }
}
